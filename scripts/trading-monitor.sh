...
BALANCE_OUTPUT=$(bankr prompt "What is my total portfolio balance in USD?" 2>/dev/null)
log "Balance: $BALANCE_OUTPUT"

# Get top movers
log "Checking top movers..."
MOVERS=$(bankr prompt "Show me the top 5 tokens with highest price increase in the last 24 hours on Base" 2>/dev/null)
